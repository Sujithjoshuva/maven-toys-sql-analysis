...
| **5 | Sales Trend Analysis** | LAG( ), ROW_NUMBER( ), MoM, YoY Analysis | December 2022 had the highest profit (8,755); March 2023 had the highest YoY profit growth (37.94%). | [SQL](sql/05_sales_trend_analysis.sql) . [Insights](insights/05_sales_trend_analysis_insight.md)
